...
import { createIncome } from '../../../lib/actions/transaction.actions'
...
export function IncomeForm({ categories, accounts }: IncomeFormProps) {
  // 収入カテゴリのみをフィルタリング
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                <FormControl>
                  <SelectTrigger>
                    <SelectValue placeholder="収入カテゴリを選択" />
                  </SelectTrigger>
                </FormControl>
                <SelectContent>
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                  <FormControl>
                    <SelectTrigger>
                      <SelectValue placeholder="受取方法を選択" />
                    </SelectTrigger>
                  </FormControl>
                  <SelectContent>
